...
from newProject.models import Seng491DB, db_connect, create_table
...
class NewProjectPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        seng491.LAST_SCORE = item["LAST_SCORE"]
        seng491.LAST_RANK = item["LAST_RANK"]
        seng491.FIRST_SCORE = item["FIRST_SCORE"]
        seng491.FIRST_RANK = item["FIRST_RANK"]
