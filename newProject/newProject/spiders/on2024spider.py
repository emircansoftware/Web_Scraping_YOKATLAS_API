...
from ..items.items import onitems2024 
from scrapy.loader import ItemLoader
from ..urls import onDepartmentID2024


class onData2024(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in onDepartmentID2024:
            urls.append('https://yokatlas.yok.gov.tr/content/onlisans-dynamic/3000_1.php?y='+str(i))
        for url in urls:
