...
from ..items.items import items2023
from scrapy.loader import ItemLoader
from ..urls import departmentID2023


class Data2023(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in departmentID2023:
            urls.append('https://yokatlas.yok.gov.tr/2023/content/lisans-dynamic/1000_1.php?y='+str(i))
        for url in urls:
