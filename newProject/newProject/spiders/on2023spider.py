...
from ..items.items import onitems2023 
from scrapy.loader import ItemLoader
from ..urls import onDepartmentID2023


class onData2023(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in onDepartmentID2023:
            urls.append('https://yokatlas.yok.gov.tr/2023/content/onlisans-dynamic/3000_1.php?y='+str(i))
        for url in urls:
