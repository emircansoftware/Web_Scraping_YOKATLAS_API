...
from ..items.items import items2020 
from scrapy.loader import ItemLoader
from ..urls import departmentID2020


class Data2020(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in departmentID2020:
            urls.append('https://yokatlas.yok.gov.tr/2020/content/lisans-dynamic/1000_1.php?y='+str(i))
        for url in urls:
