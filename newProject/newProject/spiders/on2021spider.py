...
from ..items.items import onitems2021 
from scrapy.loader import ItemLoader
from ..urls import onDepartmentID2021


class onData2021(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in onDepartmentID2021:
            urls.append('https://yokatlas.yok.gov.tr/2021/content/onlisans-dynamic/3000_1.php?y='+str(i))
        for url in urls:
