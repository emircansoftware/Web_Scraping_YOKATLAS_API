...
from ..items.items import items2022 
from scrapy.loader import ItemLoader
from ..urls import departmentID2022


class Data2022(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in departmentID2022:
            urls.append('https://yokatlas.yok.gov.tr/2022/content/lisans-dynamic/1000_1.php?y='+str(i))
        for url in urls:
