...
from ..items.items import items2019 
from scrapy.loader import ItemLoader
from ..urls import departmentID2019


class Data2019(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in departmentID2019:
            urls.append('https://yokatlas.yok.gov.tr/2019/content/lisans-dynamic/1000_1.php?y='+str(i))
        for url in urls:
