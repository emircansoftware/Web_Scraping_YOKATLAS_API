...
from ..items.items import onitems2019 
from scrapy.loader import ItemLoader
from ..urls import onDepartmentID2019


class onData2019(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in onDepartmentID2019:
            urls.append('https://yokatlas.yok.gov.tr/2019/content/onlisans-dynamic/3000_1.php?y='+str(i))
        for url in urls:
