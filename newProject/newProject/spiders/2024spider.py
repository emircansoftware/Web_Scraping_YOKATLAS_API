...
from ..items.items import items2024 
from scrapy.loader import ItemLoader
from ..urls import departmentID2024


class Data2024(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in departmentID2024:
            urls.append('https://yokatlas.yok.gov.tr/content/lisans-dynamic/1000_1.php?y='+str(i))
        for url in urls:
