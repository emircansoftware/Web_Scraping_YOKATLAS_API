...
from ..items.items import onitems2020 
from scrapy.loader import ItemLoader
from ..urls import onDepartmentID2020


class onData2020(scrapy.Spider) :
    ...
    def start_requests(self):
        urls=[]
        for i in onDepartmentID2020:
            urls.append('https://yokatlas.yok.gov.tr/2020/content/onlisans-dynamic/3000_1.php?y='+str(i))
        for url in urls:
