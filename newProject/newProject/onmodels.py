...
class Seng491DB(DeclarativeBase):  
    __tablename__ = 'on_Information_2024'  
    ...
    LAST_SCORE_12 = Column('LAST_SCORE_12', Text)#integer
    LAST_RANK_12 = Column('LAST_RANK_12', Text)#integer
    LAST_SCORE_18 = Column('LAST_SCORE_18', Text)#integer
    LAST_RANK_18 = Column('LAST_RANK_18', Text) #integer
